...
public class ProofOfConcept {
	/*
	 * static RegulatedMotor ma = new EV3MediumRegulatedMotor(MotorPort.A); static
	 * RegulatedMotor mb = new EV3MediumRegulatedMotor(MotorPort.B); static
	 * RegulatedMotor mc = new EV3MediumRegulatedMotor(MotorPort.C); static Wheel
	 * wheela = WheeledChassis.modelHolonomicWheel(ma, 61).polarPosition(30,70
	 * ).gearRatio(1); static Wheel wheelb = WheeledChassis.modelHolonomicWheel(mb,
	 * 61).polarPosition(150,70 ).gearRatio(1); static Wheel wheelc =
	 * WheeledChassis.modelHolonomicWheel(mc, 61).polarPosition(270,70
	 * ).gearRatio(1); static Chassis chassis = new WheeledChassis(new Wheel[] {
	 * wheela, wheelb, wheelc }, WheeledChassis.TYPE_HOLONOMIC);
	 */
